/**
 *  DeLock Z-Wave Door / Window Sensor with Magnet (78008)
 *
 *  Copyright 2018 John Ashton
 ...
 */
metadata {
	definition (name: "DeLock Z-Wave Door / Window Sensor with Magnet (78008)", namespace: "bjashton", author: "John Ashton") {
		...
		fingerprint mfr: "0086", prod: "0000", model: "000D"
	}
